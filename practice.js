...
// person, book, movie, holiday. Have the values to those keys be your favorite
...
// being your favorite car and then another key named 'brand' with the value being
// your favorite brand.
...
//Now change the value of the food key in your favoriteThings object to be
// 'Chicken Nuggets' and change the value of the book key in your favoriteThings o
// bject to be 'Harry Potter'.
...
*/
  ...
  function bindCard(person, creditCard){
    ...
    for(var prop in creditCard){
      newPerson[prop] = creditCard[prop];
    }
    return newPerson;
  }
